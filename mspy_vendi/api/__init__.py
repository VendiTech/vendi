...
from mspy_vendi.domain.user.schemas import UserBaseDetail, UserCreate
...
auth_router.include_router(
    fastapi_users.get_register_router(UserBaseDetail, UserCreate), tags=[ApiTagEnum.AUTH_RESISTER]
)
auth_router.include_router(fastapi_users.get_verify_router(UserBaseDetail), tags=[ApiTagEnum.AUTH_VERIFY])
